...
@objc(DBHeight)
public class DBHeight: NSManagedObject, Decodable {
	...
	required convenience public init(from decoder: Decoder) throws {
		...
		guard let entity = NSEntityDescription.entity(forEntityName: "DBHeight", in: context) else { fatalError() }
